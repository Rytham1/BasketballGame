...
def main():
    ...
    #court = pygame.image.load("court.jpg")
    #court = pygame.transform.scale(court,(1280,640))

    hoop = pygame.image.load("hoop.png")
    hoop = pygame.transform.scale(hoop,(250,400))
    ...
    while True:
        ...
        screen.fill(WHITE)
        #screen.blit(court, (0,300))
        screen.blit(hoop, (1000, 240))

        #world.add_rim("hoop.png", 130).set_pos([1090,240])
        power.draw(screen)
        world.draw(screen)
        pygame.draw.arc(screen, RED, (50, 50, 50, 50), 1, 1, 10)
        # draw rim line
        #pygame.draw.line(screen, BLACK, [1000, 340], [1075, 340], 10)
        # draw backboard
        #pygame.draw.line(screen, BLACK, [1075, 250], [1075, 640], 10)
